...
local PlayerLeavingConnection = Players.PlayerRemoving:connect(function(player)
    if player.Name == Players.LocalPlayer.Name then
        ...
        WriteToLog(GenerateLogMessage("VERIFYINFOHASH",LogHash))
        WriteToLog(GenerateLogMessage("VERIFYINFOTIMEUNIX",os.time()))
        WriteToLog(GenerateLogMessage("VERIFYINFOTIMESYS",tick()))
